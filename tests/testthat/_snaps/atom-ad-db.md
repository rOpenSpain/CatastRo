# catr_atom_get_address_db_all() returns NULL when offline
...
# address database functions warn about deprecated cache arguments
...
# catr_atom_get_address_db_to() handles a failed cached request
