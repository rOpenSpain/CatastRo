# catr_atom_get_buildings_db_all() returns NULL when offline
...
# catr_atom_get_buildings_db_to() returns NULL when offline
...
# catr_atom_get_buildings_db_all() returns NULL after an HTTP 404
...
# catr_atom_get_buildings_db_to() ranks office matches
...
# building database functions warn about deprecated cache arguments
...
# catr_atom_get_buildings_db_to() handles a failed cached request
