...
test_that("Test atom bu", {
  ...
  expect_silent(
    nmel <- catr_atom_get_buildings_db_to(to = "Melilla", cache_dir = tempdir())
  )
  ...
  expect_silent(
    pal <- catr_atom_get_buildings_db_to(to = "Palencia", cache_dir = tempdir())
  )
  ...
  # full name
  expect_silent(
    val <- catr_atom_get_buildings_db_to(to = "valencia", cache_dir = tempdir())
  )
