...
- For bugs, [file an
  issue](https://github.com/rOpenSpain/CatastRo/issues/new).
...
requests](https://github.com/rOpenSpain/CatastRo/issues) to make sure
...
The **rOpenSpain** community maintains **CatastRo** on a volunteer
basis, so a response may not be immediate. Maintainers may address
issues in batches, which can delay responses. A good **reprex** is
particularly important because it lets us investigate a problem when we
have capacity. If we cannot reproduce a bug, we cannot fix it.
