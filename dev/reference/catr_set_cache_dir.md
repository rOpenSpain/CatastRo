...
#> ℹ CatastRo cache directory is /tmp/RtmpVPgBUj/example/cachenew.
#> ℹ To reuse this cache directory in future sessions, set `install` to `TRUE`.

catr_detect_cache_dir()
#> ℹ /tmp/RtmpVPgBUj/example/cachenew
#> [1] "/tmp/RtmpVPgBUj/example/cachenew"
