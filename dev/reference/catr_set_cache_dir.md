...
#> ℹ /tmp/Rtmpimcdoj/CatastRo

# Set an example cache
ex <- file.path(tempdir(), "example", "cachenew")
catr_set_cache_dir(ex)
#> ℹ CatastRo cache dir is /tmp/Rtmpimcdoj/example/cachenew.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.

catr_detect_cache_dir()
#> ℹ /tmp/Rtmpimcdoj/example/cachenew
#> [1] "/tmp/Rtmpimcdoj/example/cachenew"

# Restore initial cache
catr_set_cache_dir(my_cache)
#> ℹ CatastRo cache dir is /tmp/Rtmpimcdoj/CatastRo.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
