...
This guide explains how to propose a change to **CatastRo**. Review the
...
someone from the **rOpenSpain** team agrees that it is needed. If you
have found a bug, file an issue that illustrates it with a minimal
...
Please note that the **CatastRo** project is released with a
[Contributor Code of
Conduct](https://ropenspain.github.io/CatastRo/dev/CODE_OF_CONDUCT.md).
