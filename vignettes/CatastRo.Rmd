...
labs <- catr_wms_get_layer(stadium_parcel,
  what = "parcel",
...
```r
valencia_bu <- catr_atom_get_buildings("Valencia",
...
In case of doubt, the function `catr_atom_get_buildings_db_all()` provides the names and
...
buff <- esp_get_capimun(munic = "^València$") %>%
