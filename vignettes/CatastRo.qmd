...
download official information on addresses, properties, parcels and buildings.
...
- **Vector objects:** Parcels, addresses, buildings, cadastral zones and more.
  **CatastRo** provides these objects as `sf` objects, using the **sf**
  package.
- **Imagery:** Image layers representing the same information as the vector
  objects. **CatastRo** provides these objects as `SpatRaster` objects,
...
<div class="figure">
<img src="./santbernabeu-1.png" alt="Figure 1: Santiago Bernabeu example" width="100%" />
<p class="caption">Figure 1: Santiago Bernabeu example</p>
</div>
...
city_catr_code
#> # A tibble: 1 × 12
#>   munic   catr_to catr_munic catrcode cpro  cmun  inecode nm     
#>   <chr>   <chr>   <chr>      <chr>    <chr> <chr> <chr>   <chr>  
#> 1 GRANADA 18      900        18900    18    087   18087   GRANADA
#> # ℹ 4 more variables: cd <chr>, cmc <chr>, cp <chr>, cm <chr>

city_bu <- catr_atom_get_buildings(city_catr_code$catrcode)
```

Next, we limit the analysis to a circle
