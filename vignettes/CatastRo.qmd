...
- **Vector objects:** Parcels, addresses, buildings, cadastral zones and more.
  These objects are provided by **CatastRo** as `sf` objects as provided by the
  **sf** package.
- **Imagery:** Image layers representing the same information as the vector
  objects. These objects are provided by **CatastRo** as `SpatRaster` objects as
...
<div class="figure">
<img src="./santbernabeu-1.png" alt="Figure 1: Example - Santiago Bernabeu" width="100%" />
<p class="caption">Figure 1: Example - Santiago Bernabeu</p>
</div>
