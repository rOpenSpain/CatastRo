...
This API retrieves the spatial coordinates of an urban property. You do not
...
The API can also obtain the RC of an urban property from longitude and latitude.
It allows you to choose the spatial reference system (SRS, also known as CRS)
used to express the coordinates.
...
`catr_ovc_get_rccoor()` takes the coordinates (`lat` and `lon`) and
